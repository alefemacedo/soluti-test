...
namespace DoctrineORMModule\Proxy\__CG__\SocialContract\V1\Rest\PessoaFisica;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class PessoaFisicaEntity extends \SocialContract\V1\Rest\PessoaFisica\PessoaFisicaEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PessoaFisicaEntity $proxy) {
